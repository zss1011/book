    ...
    children: [
        {
            ...
            meta: {menu: true, bookName: '仪表盘', icon: 'Notification', path: '/dash/board'},
        },
        {
            path: 'user',
            component: () => import('@/views/admin/user/User.vue'),
            meta: {menu: true, bookName: '用户管理', icon: 'plus', path: '/user'}
        },
        {
            path: 'book',
            component: () => import('@/views/admin/book/Book.vue'),
            meta: {menu: true, bookName: '书籍管理', icon: 'Connection', path: '/book'}
        },
        {
            path: 'book-type',
            component: () => import('@/views/admin/book-type/bookType.vue'),
            meta: {menu: true, bookName: '书籍类别', icon: 'Notebook', path: '/book-type'}
        },
        {
            path: 'bookrack',
            component: () => import('@/views/admin/bookrack/bookrack.vue'),
            meta: {menu: true, bookName: '书架配置', icon: 'List', path: '/bookrack'}
        },
        {
            path: 'borrow',
            component: () => import('@/views/admin/borrow/Borrow.vue'),
            meta: {menu: true, bookName: '借阅记录', icon: 'List', path: '/borrow'}
        },
        {
            path: 'notice',
            component: () => import('@/views/admin/notice/Notice.vue'),
            meta: {menu: true, bookName: '公告管理', icon: 'Notification', path: '/notice'},
        },
        {
            path: 'notice/add',
        ...
        },
        {
            ...
            meta: {menu: true, bookName: 'child', icon: 'ChatDotRound', path: '/child'},
            redirect: '/child/child1',
            children: [
                {
                    path: 'child1',
                    component: () => import('@/views/admin/child/Child1.vue'),
                    meta: {menu: true, bookName: 'child1', icon: 'Setting', path: '/child/child1'},
                },
                {
                    path: 'child2',
                    component: () => import('@/views/admin/child/Child2.vue'),
                    meta: {menu: true, bookName: 'child2', icon: 'Clock', path: '/child/child2'},
                }
            ]
        }
    ]
